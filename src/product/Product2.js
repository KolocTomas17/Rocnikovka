  ...
  return (
    <>
      ...
      <section className="columns">
        <img className="pic column is-half" src={Audi} alt="Audi rs6" />
        ...
        <div className="column is-one-third asistenty">
          ...
          <p className="tittle popisek">
            Adaptivní tempomat, Asistent rozjezdu do kopce, Parkovací asistent,
            Parkovací kamera, Parkovací senzory, Rozpoznávání dopravních značek,
            Tempomat, Parkovací senzory přední, Parkovací senzory zadní
          </p>
        </div>
      </section>
      <Footer></Footer>
