  ...
  return (
    <>
      ...
      <section className="columns">
        <img className="pic column is-half" src={MB} alt="Mercedes-Benz" />
        ...
        <div className="column is-one-third asistenty">
          ...
          <p className="tittle popisek">
            ABS, centrální zamykání, El. ovládání oken, El. ovládání zrcátek,
            Nezávislé topení s čas. předehřívačem, Posilovač řízení, Venkovní
            teploměr
          </p>
        </div>
      </section>
