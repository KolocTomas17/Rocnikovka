  ...
  return (
    <>
      ...
      <section className="columns">
        <img className="pic column is-half" src={Urus} alt="Lexus" />
        ...
        <div className="column is-one-third asistenty">
          ...
          <p className="tittle popisek">
            360° monitorovací systém (AVM), Adaptivní tempomat, Parkovací
            kamera, Parkovací senzory, Rozpoznávání dopravních značek, Parkovací
            senzory přední, Parkovací senzory zadní, Sledování jízdního pruhu,
            Sledování únavy řidiče, Hlídání mrtvého úhlu
          </p>
        </div>
      </section>
      <Footer></Footer>
