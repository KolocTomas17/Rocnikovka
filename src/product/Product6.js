  ...
  return (
    <>
      ...
      <section className="columns">
        <img className="pic column is-half" src={Porsche} alt="Porsche" />
        ...
        <div className="column is-one-third asistenty">
          ...
          <p className="tittle popisek">
            ABS, ESP, Hlídání mrtvého úhlu, Protiprokluzový systém kol (ASR),
            Sledování jízdního pruhu, Adaptivní tempomat, Parkovací kamera,
            Parkovací senzory, Rozpoznávání dopravních značek, Parkovací senzory
            přední, Parkovací senzory zadní
          </p>
        </div>
      </section>
      <Footer></Footer>
